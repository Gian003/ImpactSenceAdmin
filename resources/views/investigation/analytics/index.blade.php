...
<div class="row g-3 mb-4">
    ...
    <div class="col-lg-4">
        <div class="chart-card p-3 h-100" style="overflow-y:auto; max-height:460px;">
            ...
            {{-- Clicking pans/zooms the map to this area's incidents — see
                 toc/analytics/index.blade.php for the fuller note on why the
                 sidebar (address-text ranking) and the map (GPS-proximity
                 clustering) don't visually match on their own. --}}
...
<script>
    window.InvestigationAnalyticsConfig = {
...
<script src="{{ asset('js/investigation/analytics.js') }}?v={{ filemtime(public_path('js/investigation/analytics.js')) }}"></script>
