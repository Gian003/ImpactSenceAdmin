...
@php
    // Reached via investigation.incident-records.show, so $incident carries
    // real data to prefill below; the investigator still reviews/completes
    // every field before printing.
