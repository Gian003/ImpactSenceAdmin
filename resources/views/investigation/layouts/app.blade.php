...
<body>
    ...
    <div class="d-flex" style="min-height:100vh;">
        ...
        <aside class="sidebar d-flex flex-column">
            ...
            <nav class="flex-grow-1 py-3">
                ...
                {{-- Registered Device --}}
                <a href="{{ route('investigation.devices.index') }}"
                    class="nav-link {{ request()->routeIs('investigation.devices*') ? 'active' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        viewBox="0 0 24 24">
    ...
    {{-- Pusher real-time listener — only loads when PUSHER_APP_KEY is configured.
         Investigation cares about accidents and their status (dispatched/
         resolved), not patrol dispatch/registration internals, so this only
         subscribes to the 'incidents' channel — not 'patrol-registrations' or
         'patrol-locations' like the TOC layout does. --}}
